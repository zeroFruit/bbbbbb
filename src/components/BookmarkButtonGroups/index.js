...
class BookmarkButtonGroups extends PureComponent {
  render() {
    return (
...
BookmarkButtonGroups.propTypes = propTypes;
BookmarkButtonGroups.defaultProps = defaultProps;

export default BookmarkButtonGroups;
